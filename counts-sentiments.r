...
text <- paste(readLines("bmsource.csv"), collapse = "\n")
...
wf <- read_csv(sprintf("word_frequency.csv"))
wf
...
write.csv(bing_word_counts, file = "wordsentiment-bm-tweet-data.csv")

#code to setup output plot to file
dpi=600    #pixels per square inch
png("bingfigure.png", width=9*dpi, height=9*dpi, res=dpi)
##
